...
anchors as (
    ...
    select
        ...
        latitude as anchor_latitude,
        longitude as anchor_longitude,
...
anchor_with_matches as (
    ...
    select
        a.anchor_source_system,
        a.anchor_source_type,
        a.anchor_source_record_id,

        a.anchor_business_name,
        a.anchor_address,
        a.anchor_city,
        a.anchor_state,
        a.anchor_postal_code,
        a.anchor_place_category,
        a.anchor_source_says_active,
        a.anchor_source_specific_evidence,
...
clustered as (
    ...
    select
        ...
        case
            when count(matched_source_record_id) = 0 then 1
            else count(matched_source_record_id) + 1
        end as total_source_records,

        case
            when count(distinct matched_source_system) = 0 then 1
            else count(distinct matched_source_system) + 1
        end as matched_source_count,
